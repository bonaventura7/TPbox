...
const AGREEMENTS_DEMO: CoveredTaxAgreement[] = [
  ...
  },
  {
    ...
    jurisdiction2: "ESP",
    title:
      "Convention between Italy and Spain for the Avoidance of Double Taxation with respect to Taxes on Income and for the Prevention of Fiscal Evasion", // vedi posizione Italia
    statusAsOf: "2023-06-30",
  },
];
