...
const MONEY_AND_CREDIT_METRICS: readonly Metric[] = [
  ecbRate(
    ...
    "Media del mese (HSTA). Le serie Euribor giornaliere non sono esposte dall'attuale data API BCE con le chiavi note.",
  ),
  ecbRate(
    "EURIBOR_6M_M",
  ...
  treasuryRate(
    ...
    "Treasury USA 3 mesi",
    "BC_3MONTH",
    "Treasury Daily Par Yield Curve, constant maturity; fonte primaria U.S. Treasury.",
  ),
  treasuryRate(
    "US_TREASURY_6M",
    "Treasury USA 6 mesi",
...
export const REFERENCE_BASIS_NOTE =
  "Rendimenti di titoli di stato alla stessa scadenza: curva dell'area euro (titoli AAA, BCE) per l'euro, Treasury constant maturity (U.S. Treasury Daily Par Yield Curve) per il dollaro.";
