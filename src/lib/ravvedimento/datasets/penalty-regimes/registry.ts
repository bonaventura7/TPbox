...
export const PENALTY_REGIMES: Regime[] = [
  {
    ...
    bands: [
      ...
      },
      {
        id: "breve",
        maxDaysLate: 30,
        description: "Entro 30 giorni: 1/10 del 15%",
        effectiveRateBp: 150,
      },
      {
        id: "trimestrale",
        maxDaysLate: 90,
        description: "Entro 90 giorni: 1/9 del 15%",
        effectiveRateBp: 167,
      },
      {
        id: "annuale",
        maxDaysLate: 365,
        description: "Entro un anno: 1/8 del 30%",
        effectiveRateBp: 375,
      },
      {
        id: "biennale",
        maxDaysLate: 730,
        description: "Entro due anni: 1/7 del 30%",
        effectiveRateBp: 429,
      },
      {
        id: "ultrabiennale",
        maxDaysLate: null,
        description: "Oltre due anni: 1/6 del 30%",
        effectiveRateBp: 500,
      },
    ],
  },
  {
    ...
    bands: [
      ...
      },
      {
        id: "breve",
        maxDaysLate: 30,
        description: "Entro 30 giorni: 1/10 del 12,5%",
        effectiveRateBp: 125,
      },
      {
        id: "trimestrale",
        maxDaysLate: 90,
        description: "Entro 90 giorni: 1/9 del 12,5%",
        effectiveRateBp: 139,
      },
      {
        id: "annuale",
        maxDaysLate: 365,
        description: "Entro un anno: 1/8 del 25%",
        effectiveRateBp: 313,
      },
      {
        id: "biennale",
        maxDaysLate: 730,
        description: "Entro due anni: 1/7 del 25%",
        effectiveRateBp: 357,
      },
      {
        id: "ultrabiennale",
        maxDaysLate: null,
        description: "Oltre due anni: 1/6 del 25%",
        effectiveRateBp: 417,
      },
    ],
  },
