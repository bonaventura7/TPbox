...
export async function searchUrAccounting(companyName: string, timeoutMs = 30000): Promise<UrResult> {
  ...
  // Ritirata la catena di ripiego che interrogava i motori di ricerca e leggeva
  // unternehmen24.info con espressioni regolari: un valore letto cosi non e'
  // riconducibile a un deposito e non regge in verifica fiscale. Senza
  // OpenRegister la Germania dichiara l'indisponibilita' invece di stimare.
  void candidates;
