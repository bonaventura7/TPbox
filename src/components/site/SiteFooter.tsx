      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-3">
        <div>
          ...
          <p className="mt-2 max-w-sm text-sm text-muted-foreground">
            Progetto editoriale indipendente dedicato alla documentazione, alla prassi e
            agli strumenti di analisi in materia di prezzi di trasferimento.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            Tutti i contenuti visibili in questo prototipo sono dati dimostrativi
            sintetici. Nessun contenuto reale viene scaricato dal browser e nessun
            elemento acquisito viene pubblicato automaticamente.
          </p>
        </div>
      </div>
      <div className="border-t border-border">
        <p className="mx-auto max-w-6xl px-4 py-4 text-xs text-muted-foreground sm:px-6">
          Prototipo editoriale · dati demo · nessuna affiliazione con enti, editori o
          testate terze.
        </p>
      </div>
    </footer>
