  ...
  head: () => ({
    meta: [
      { title: "Risultato analisi BEPS MLI — Osservatorio Transfer Pricing" },
      {
        name: "description",
        content:
          "Matching outcome BEPS MLI per un trattato bilaterale a una data di riferimento, con dati dimostrativi.",
      },
      {
        property: "og:title",
        content: "Risultato analisi BEPS MLI — Osservatorio Transfer Pricing",
      },
      {
      ...
      <div className="container mx-auto max-w-5xl px-4 py-8">
        <div className="mb-6">
          ...
          <p className="mt-2 text-muted-foreground text-sm">
            Stato al <strong>{statusAsOf}</strong> ("Status as of"). Dati demo basati su posizioni
            MLI interne.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 mb-6">
          <div className="rounded-lg border bg-card p-4 text-sm">
            ...
            <p className="text-muted-foreground">
              Signatario: {j1Data?.isSignatory ? "sì" : "no"} — Parte:{" "}
              {j1Data?.isParty ? "sì" : "no"}
            </p>
          ...
          <div className="rounded-lg border bg-card p-4 text-sm">
            ...
            <p className="text-muted-foreground">
              Signatario: {j2Data?.isSignatory ? "sì" : "no"} — Parte:{" "}
              {j2Data?.isParty ? "sì" : "no"}
            </p>
            <p className="mt-1 text-muted-foreground">
        ...
        {outcome ? (
          <div className="mb-8 rounded-lg border bg-card p-4">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              ...
              implementazione estesa, qui verrebbero mostrati tutti gli articoli rilevanti (6, 7, 9,
              13, ecc.).
            </p>
          ...
          <div className="mb-8 rounded-lg border bg-card p-4 text-sm text-muted-foreground">
            <p>
              Nessun matching outcome demo disponibile per la coppia selezionata. Al momento il
              dataset interno contiene solo Italia–Francia.
            </p>
          </div>
        )}
        ...
        <div className="rounded-lg border bg-muted p-4 text-xs text-muted-foreground">
          <p>
            <strong>Nota demo:</strong> questa pagina usa dati interni semplificati per illustrare
            il matching MLI tra due paesi. Per l'analisi completa, in fasi successive verrà esteso
            il dataset e l'interfaccia di ricerca avanzata.
          </p>
        </div>
      </div>
    </>
