    ...
    <div className="container mx-auto max-w-5xl px-4 py-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          Fonti ufficiali, prassi amministrativa e giurisprudenza tributaria, selezionate e
          contestualizzate per il transfer pricing.
        </p>
      </div>
      ...
      <div className="mt-12 space-y-4">
        ...
        <p className="text-sm text-muted-foreground">
          La sezione "Normativa e prassi" integra fonti ufficiali (leggi, decreti, provvedimenti,
          circolari) con strumenti di ricerca sugli interpelli e sulla giurisprudenza tributaria.
          L'obiettivo è fornire un quadro completo per analisi di transfer pricing, fiscalità
          internazionale e contenzioso.
        </p>
        <p className="text-sm text-muted-foreground">
          Per l'uso in casi reali, le interpretazioni qui proposte e le sentenze consultate devono
          essere sempre valutate alla luce della normativa vigente e delle Linee Guida OCSE, con il
