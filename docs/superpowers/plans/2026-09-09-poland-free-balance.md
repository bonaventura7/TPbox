...
- [x] **Step 1: Implement the smallest fallback**
...
- [x] **Step 3: Prefer direct ALEO HTML**
...
- [x] **Step 1: Add regression for provider exhaustion**
...
- [x] **Step 1: Run the complete Guardrail CI test set locally if dependencies are available**
