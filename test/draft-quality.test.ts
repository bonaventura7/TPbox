...
const validDraft = {
  ...
  summary:
    "Il SII ha pubblicato un chiarimento specifico sulla valutazione dei beni immateriali. Il documento precisa i criteri applicabili alle operazioni infragruppo.",
